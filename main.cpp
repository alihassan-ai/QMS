...
#include "Resource Files/Header.h"
// Classes
// Abstract Class
...
class admin : public first, public check, public auth
{
private:
	// admin credentials:
	const string admin_username = "dudu";
	const string admin_password = "789789";
...
public:
	void add_student()
	{
		do
		{
			...
			Add_student.open("/student.txt", ios::app);
			if (!Add_student)
			{
	...
	void add_teacher()
	{
		do
		{
			...
			ofstream teacher;
			teacher.open("/teacher.txt", ios::app);
			if (!teacher)
			{
...
class teacher : public auth, public check, public paper, public first
{
private:
	int choice;
	int usr;
...
class student : public auth, public check,  public paper, public first
{
private:
	int valid;
	int choice;
